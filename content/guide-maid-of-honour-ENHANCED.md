# The Maid of Honour Speech Guide — EXPANDED (ready to paste)

URL: `/moh-speeches`
TITLE: How to Write a Maid of Honour Speech: Structure, Examples & Tips (2026)
META: How to write a maid of honour speech that's funny and touching — structure, opening lines, examples and a full sample. By a professional speechwriter.

NOTE on what's new: this page didn't previously rank, so it's been EXPANDED, not just preserved. Your original material is kept and tidied. Newly written (original, in-style) additions = the "What should it include?" section, the example opening lines, the example funny lines, the "balance funny and emotional" section, and the full worked example speech. Length reconciled to 5–7 minutes / ~750–1,000 words throughout.

SCHEMA to inject (Article + FAQPage from the questions + BreadcrumbList Home → Guides → How to Write a Maid of Honour Speech):
```json
{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "How to Write a Maid of Honour Speech",
  "url": "https://www.allspeechesgreatandsmall.com/moh-speeches",
  ...
  "mainEntityOfPage": "https://www.allspeechesgreatandsmall.com/moh-speeches",
  "description": "How to write a maid of honour speech that's funny and touching — structure, opening lines, examples and a full sample."
}
```
