# How to Write a Eulogy — GUIDE (ready to paste)

URL: `/eulogy-examples`
TITLE: How to Write a Eulogy: A Gentle Step-by-Step Guide with Examples
META: A compassionate, step-by-step guide to writing a eulogy — what to include, how long it should be, structure and a full example. Written by a professional writer.

NOTE: This is a new, from-scratch guide (gentle, respectful tone — no hard selling). Written in Adrian's voice. British spelling throughout.

SCHEMA to inject (Article + FAQPage from the questions + BreadcrumbList Home → Guides → How to Write a Eulogy):
```json
{
  "@context": "https://schema.org",
  "@type": "Article",
  "headline": "How to Write a Eulogy",
  "url": "https://www.allspeechesgreatandsmall.com/eulogy-examples",
  ...
  "mainEntityOfPage": "https://www.allspeechesgreatandsmall.com/eulogy-examples",
  "description": "A compassionate, step-by-step guide to writing a eulogy — what to include, how long it should be, structure and a full example."
}
```
