...
headline: "How to Write a Best Man Speech"
description: "A step-by-step guide to writing a best man speech, structure, opening lines, jokes that land, and full examples. Written by a professional speechwriter."
path: "/best-man-speeches/"
hero: "/images/card-best-man.webp"
service: "/best-man-speech-writer/"
...
faqs:
  ...
  - q: "How do you start a best man speech?"
    a: "Open with a warm, funny line that earns a genuine laugh, never edgy, then introduce yourself. Quality matters more than racing to the first gag."
  - q: "How should you structure a best man speech?"
    a: "Keep it simple: form a logical progression from one point to the next, don't let the timeline jump around, and never cover the same topic or person twice."
  - q: "Should you talk about being the best man?"
    a: "No, skip the moment he asked you and your best man duties. It's filler. The speech is only ever about the groom."
  - q: "How do you move from the introduction into the speech?"
    a: "Use a short \"bridge\" line that links your opening to the main part of the speech, keep it simple so guests don't have to work to follow."
  - q: "What should you say about how you know the groom?"
    a: "Establish your connection to the groom right after the bridge so the audience instantly understands why you're up there, and have some fun with it."
  - q: "How do you tell stories in a best man speech?"
    a: "Make the whole speech one story rather than dragging the audience through endless anecdotes, pull out the \"good bits\", condense them, and even embellish slightly into neat bursts of comedy."
  - q: "What about the groom's triumphs and disasters?"
    a: "These are ripe areas for comedy, hint at his real accomplishments (save those for later) and have affectionate fun with the things he got catastrophically wrong."
  - q: "How do you talk about how the bride changed the groom?"
    a: "Have fun with how the groom has upped his game since meeting her, the new wardrobe, the wider horizons, the interests beyond pubs and football."
  - q: "What should you say about the bride?"
    a: "Be warm and respectful, and since the groom has already covered how they met, allude to it only generally, avoid repetition and avoid the details."
  - q: "How do you end a best man speech with a toast?"
    a: "There should be only one toast in a best man speech, and it comes right at the very end, simple and effective."
  - q: "How do you close a best man speech?"
    a: "Tie all the strands together and finish on what a great friend or brother the groom is, how he's been there for you through the good times and the difficult ones."
  - q: "Should you use props in a best man speech?"
    a: "Avoid props at all costs, the moment people look at a photo or a screen instead of you, you lose the room. Pin funny photos by the seating plan instead."
  - q: "Should you use quotes in a best man speech?"
    a: "Just one well-chosen, less familiar quote can end a speech beautifully, avoid the clichés, and don't turn it into a Literature essay."
  - q: "How do you handle hecklers?"
    a: "Plan ahead: the simplest method is to pause, let them finish and carry on, but if you can turn it into a gentle extra laugh, so much the better."
  - q: "What jokes work in a best man speech?"
    a: "Skip the recycled \"best man jokes\" everyone has heard a hundred times, work out what's genuinely funny about the groom and people will laugh far more at your originality."
  - q: "How long should a best man speech be?"
    a: "In the UK, with three speakers, aim for a stand-up-to-sit-down time of no more than 10 minutes, about 5 in America, and cut it shorter as more speakers are added."
  - q: "How do joint best man speeches work?"
    a: "Sort it out early, and ideally make one joint speech of about four content \"chunks\" each, bouncing between you, it avoids doubling up and saves anyone the dreaded last slot."
  - q: "How do you write a best man speech for your brother?"
    a: "Being his brother means you have less \"how we met\" material, so mine his character, passions, job and the sibling dynamic for comedy, and have fun with the childhood rivalry in your intro."
  - q: "Should you mention the groom's ex-girlfriends?"
    a: "No. Never mention former girlfriends in any way, the day is really about the bride, and upsetting her is terminal."
  - q: "How should you deliver the speech?"
    a: "Practise out loud until you know it well enough to look up from your cards, delivery matters as much as the words."
---
## The ultimate best man speech guide, 10 minutes you'll remember forever
...
**Open with a warm, funny line that earns a genuine laugh, never edgy, then introduce yourself. Quality matters more than racing to the first gag.**
...
## How should you structure a best man speech? (Structure)
**Keep it simple: form a logical progression from one point to the next, don't let the timeline jump around, and never cover the same topic or person twice.**
...
## Should you talk about being the best man? (Being Best Man)
**No, skip the moment he asked you and your best man duties. It's filler. The speech is only ever about the groom.**
...
## How do you move from the introduction into the speech? (The Bridge)
**Use a short "bridge" line that links your opening to the main part of the speech, keep it simple so guests don't have to work to follow.**
...
## What should you say about how you know the groom? (Relationship to Groom)
**Establish your connection to the groom right after the bridge so the audience instantly understands why you're up there, and have some fun with it.**
...
## How do you tell stories in a best man speech? (Stories)
**Make the whole speech one story rather than dragging the audience through endless anecdotes, pull out the "good bits", condense them, and even embellish slightly into neat bursts of comedy.**

The trick to writing a really entertaining speech is to make the whole thing a story, rather than dragging the audience through endless stories. Recounting anecdotes is really hard to do because they require a lot of detail and all the time you're getting to the punchline without making them laugh can prove really counterproductive. Of course, this can all pay off if you have a killer punchline, but all too frequently they aren't that 'killer' and require you to have been there. Instead take out the good bits from the stories and condense them, even embellish slightly into one neat burst of comedy…
...
## What about the groom's triumphs and disasters? (Triumphs and Disasters)
**These are ripe areas for comedy, hint at his real accomplishments (save those for later) and have affectionate fun with the things he got catastrophically wrong.**
...
## How do you talk about how the bride changed the groom? (Impact)
**Have fun with how the groom has upped his game since meeting her, the new wardrobe, the wider horizons, the interests beyond pubs and football.**
...
**Be warm and respectful, and since the groom has already covered how they met, allude to it only generally, avoid repetition and avoid the details.**

The wedding day really is only about one person, and even though the Best Man Speech should mainly be about the groom, the bride does of course have her part in it as well. The thing to remember here is, that unless you live in Australia, the best man always goes last, and so the groom will already have extensively talked about how they met. You're really looking to avoid repetition, so allude generally to how they met, and I'd avoid details…and if they met online and aren't advertising the fact, then you shouldn't either.
...
## How do you end a best man speech with a toast? (The Toast)
**There should be only one toast in a best man speech, and it comes right at the very end, simple and effective.**
...
All that remains for me is to wish you all a long and happy life together, with all the luck in the world. Ladies and gentlemen, the bride and groom.

## How do you close a best man speech? (Closing Lines)
**Tie all the strands together and finish on what a great friend or brother the groom is, how he's been there for you through the good times and the difficult ones.**
...
## Should you use props in a best man speech? (Props)
**Avoid props at all costs, the moment people look at a photo or a screen instead of you, you lose the room. Pin funny photos by the seating plan instead.**

From a vast amount of experience you should avoid using props at all costs. It might seem like a great idea to have films, photos, a man in a gimp suit taking the heat off you in a pressurised situation, but it only ever serves to make the day a lot trickier and the speech less effective. As soon as you start holding up pictures or invite people to look at pictures you've left on the table they will immediately stop looking at you and start zoning out or talking amongst themselves. If you give anyone the opportunity to divert their gaze you then have to work really hard to get it back again, and props will only ever make your speech longer and more tedious to endure. They also usually rely heavily on cables, Bluetooth connections, wifi etc etc…or at the very least everyone being able to see what you're holding up…and they never can. Suddenly you're getting heckles about not being able to see/hear/understand and it makes the speech the longest 10 minutes of your life. A great idea if you've got funny photographs is to pin them up by the seating plan so that everyone will get to see them and then you can reference those in your speech.

## Should you use quotes in a best man speech? (Quotes)
**Just one well-chosen, less familiar quote can end a speech beautifully, avoid the clichés, and don't turn it into a Literature essay.**
...
## How do you handle hecklers? (Hecklers)
**Plan ahead: the simplest method is to pause, let them finish and carry on, but if you can turn it into a gentle extra laugh, so much the better.**

You are always going to get a heckler or two so it's worth thinking in advance how to deal with them so they don't upset your flow, and even better, give you an opportunity to get some extra laughs. The most simple method is just to pause, wait until they're done and carry on, but if you can get a bit of mileage out of it, so much the better. A good way of having some fun is simply to ask if they're looking for assistance in going to the bathroom, this works particularly well if they happen to be on the slightly older side. If it's a younger person you can assume some vocal surprise that their carers have let them out for the day, or suggest that whatever medication the system has got them on, they need to cut the dose. Anything along this sort of gentle fun vein, always works a treat…as long as they don't really have a carer and aren't on medication.

## What jokes work in a best man speech? (Jokes)
**Skip the recycled "best man jokes" everyone has heard a hundred times, work out what's genuinely funny about the groom and people will laugh far more at your originality.**

In my experience best man jokes are probably the least effective addition to any best man speech that wants to be classed as superior. By best man jokes, I am alluding to about 100 or so gags that were written over the years specifically to get a laugh from wedding guests. You can do so much better than these, because they're old, tired and people have heard them all before and the last thing you want to do is land one of these at the start of your speech to a lukewarm ripple of polite laughter. To identify exactly what I'm talking about I've listed some of the most prolific offenders.

- It's an emotional wedding, even the cake is in tiers.
- It's not the first time today I've got up from a warm seat with a piece of paper in my hand.
...
Complete rubbish. You need to work out what it is that's funny about the groom in an original and engaging way, people will love your creativity and laugh much more! Burning deep within his soul was a dream, what he wanted more than anything, more than being a cowboy, professional tennis player or A ball star…was to be an office manager in the NHS. What can I say? He's not dreaming any more ladies and gentlemen.

## How long should a best man speech be? (Length)
**In the UK, with three speakers, aim for a stand-up-to-sit-down time of no more than 10 minutes, about 5 in America, and cut it shorter as more speakers are added.**

This is one of the most important factors and it actually depends on quite a few things, so we'll start off with the very general scenario of 3 speakers at a wedding, Father of the bride, Groom and Best Man. If this is the case and it's in the UK, then the best man speech should be a stand up to sit down time of no longer than 10 minutes. If this is in America, that will be about 5 minutes maximum. Americans like their speeches shorter and more efficient, and that's no bad thing. However, these timings will then change the more speakers that are added to the line up, because what the groom should be doing is making sure the section of speeches doesn't run into hours of your life you'll never get back. If there are 4 speakers, aim to be in and out in around 8 minutes, 5 speakers you're looking at about 6 minutes, and so it goes on. You have to bear in mind also that as you'll be the last speaker, apart from Australia where you're up second, and so the guests are at the limit of their concentration endurance, so if they've been sitting through 90 minutes of speeches, and it happens, make it REALLY funny, and REALLY short. If you are two best men making a joint speech then you should be stood for about 12-13 minutes, and that remains the case the more best men are added to the line up. If you're a co-best man and you're making separate speeches, then your speech should be about 7 minutes. The timings in Australia are identical to the UK except that the best man goes after the father of the bride.

## How do joint best man speeches work? (Joint Best Man)
**Sort it out early, and ideally make one joint speech of about four content "chunks" each, bouncing between you, it avoids doubling up and saves anyone the dreaded last slot.**

Being a joint best man is pretty common these days, and you really need to tackle what you're going to go about things as early as possible, because trying to coordinate two guys to write and deliver a speech whilst they juggle their own lives can prove next to impossible. The first thing you have to decide is if you're going to make a joint speech or separate ones. The best method is to make a joint speech as it means you won't double up on gags or content, and nobody has that last dreaded speech spot. A great joint best man speech should consist of about 4 chunks of content each and you bounce from one best man to other all the way through the speech. However, for many reasons making a joint speech might prove impossible. Maybe there's no time to coordinate it, maybe you don't like the guy, or maybe there's a fundamental clash of ideas. In that case make sure your speech is efficient, tight and punchy and comes in at around 7 minutes, and whatever you do, make sure you get on first.

## How do you write a best man speech for your brother? (Best Man for Brother)
**Being his brother means you have less "how we met" material, so mine his character, passions, job and the sibling dynamic for comedy, and have fun with the childhood rivalry in your intro.**

Quite a lot of grooms make their brother the best man, and that does throw up a few problems, the main one being that although you've grown up in the same family/house etc. you don't really know that much about him! When I'm writing speeches, this doesn't really affect the creative process because I'm looking for a very funny comedic overview of who the groom is, not a granular introspection. If you're facing this very common problem, then just take everything you know about his character, passion, dislikes, job and even hair colour and get the funnies out of that. It can be done but it really needs thinking about. Of course, there is some fun to be had with the introduction and you need to allude to that fact how upset you were when your number priority spot was completely usurped by a noisy, ugly ginger baby called Dave. If you're younger then talk about the time you realised the bigger toddler in the house who kept bashing you over the head every time your mum left the room, was in fact your older brother Steve.

## Should you mention the groom's ex-girlfriends? (Girlfriends)
**No. Never mention former girlfriends in any way, the day is really about the bride, and upsetting her is terminal.**
...
**Practise out loud until you know it well enough to look up from your cards, delivery matters as much as the words.**

Once your speech is written, the job is only half done. Read it aloud, over and over, until the words feel natural and you can lift your eyes from the page to the room. Print it in a large, clear font on numbered cards or a single sheet, and keep a backup on your phone. Slow right down, nerves make everyone rush, and leave a beat after each punchline so the laughter has room to land. Don't rely on Dutch courage: a single drink to steady the nerves is fine, but stay sharp enough to enjoy your moment. And remember the whole room is on your side, they desperately want you to do well. Take a breath, smile, and enjoy it.

---

### Want your best man speech written for you?
I write bespoke, original best man speeches built entirely around your friendship with the groom, funny, warm and unmistakably yours, with unlimited revisions until it's perfect.
