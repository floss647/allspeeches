---
title: "Robots in disguise - we need to talk about AI"
description: "A professional speechwriter puts ChatGPT to the test on wedding speeches. Why AI still can't handle humour, length or tone, and why that matters."
slug: "robots-in-disguise-we-need-to-talk-about-ai"
...
Throughout 2023 there have been various updates and incarnations to GPT, and with each one I think 'has the time finally come?'. The capabilities of this technology are quite incredible, and I am a huge fan, but writing creative, funny speeches? Not so much.
...
In my spare time I have experimented endlessly with GPT trying to see if it could come up with anything funny, and it's failed every single time. If you have genuinely laughed at anything it's created, then that says more about your sense of humor than it does about the failings of the technology. In years to come you might be able to train it so it begins to understand how you view things, but the dataset for that would have to be unbelievably vast, and that tech does not exist yet.
