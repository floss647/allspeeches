...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    cardImage: '/images/card-maid-of-honour-v2.webp',
  ...
  },
  {
    ...
    cardImage: '/images/card-mother-of-groom.webp',
    ...
    withPrice: true,
    heroImage: '/images/card-mother-of-groom.webp',
  ...
  },
  {
    ...
    cardImage: '/images/card-sister-of-groom.webp',
  ...
  {
    slug: '/brother-of-the-bride-speech-writer',
    key: 'brother-of-bride',
    nav: 'Brother of the Bride',
    cardTitle: 'Brother of the Bride Speech',
    cardBlurb: 'Celebrate your sister from a place only you know.',
    cardImage: '/images/card-brother-of-bride.webp',
    title: 'Brother of the Bride Speech Writer | Bespoke & Original from £399',
    meta: "A professional brother of the bride speech writer. Warm, funny and 100% original, written around your sister and your bond, never a template. The UK's most-reviewed speechwriter.",
    h1: 'Brother of the Bride Speech Writer',
    ...
    whatYouGet: {
      heading: 'What you get',
      items: [
        '<strong>A 100% original speech</strong> about your sister, never a template.',
        '<strong>Warm and funny in the right measure</strong>, judged for the room.',
        '<strong>Your unique perspective</strong>, the sister you grew up with, told with warmth and discretion.',
        '<strong>A genuine welcome</strong> for the person joining your family.',
        `<strong>Unlimited revisions</strong> and delivery in ${T} days.`,
      ],
    },
    howItWorks: [
      '<strong>Tell me about your sister</strong>, growing up together, who she’s become and who she’s marrying.',
      '<strong>I write your draft</strong>, a complete, warm and heartfelt speech.',
      '<strong>We perfect it together.</strong>',
    ],
    guidePath: null,
    guideLabel: null,
    faqs: [
      { q: 'How does it work?', a: 'You share your stories about your sister, I write the speech, and we refine it together until it’s perfect.' },
      { q: 'How do you balance funny and heartfelt?', a: 'Warm humour and real sentiment, judged so the laughs and the touching moments land in the right places.' },
      { q: 'Should I mention our parents?', a: 'A line or two is lovely; I’ll keep it balanced so it complements the other speeches.' },
      { q: 'How long does it take?', a: `Usually ${T} days; last-minute help available.` },
      { q: 'Will it sound like me?', a: 'Always, it’s your voice and your bond with your sister.' },
    ],
  },
  {
    slug: '/bride-speech-writer',
    key: 'bride',
    nav: 'Bride',
    cardTitle: 'Bride Speech',
    cardBlurb: 'Your day, your words, beautifully done.',
    cardImage: '/images/card-bride.webp',
    title: 'Bride Speech Writer | Bespoke & Original from £399',
    meta: "A professional bride speech writer. Heartfelt, funny and 100% original, written around your story and the people you love, never a template. The UK's most-reviewed speechwriter.",
    h1: 'Bride Speech Writer',
    ...
    whatYouGet: {
      heading: 'What you get',
      items: [
        '<strong>A 100% original bride speech</strong>, built around your story, never a template.',
        '<strong>The perfect balance of funny and heartfelt</strong>, judged so it lands in all the right places.',
        '<strong>Every thank-you handled gracefully</strong>, in the right order, without it dragging.',
        '<strong>The words for your partner</strong> that you mean but can’t quite phrase yourself.',
        `<strong>Unlimited revisions</strong> and delivery in ${T} days.`,
      ],
    ...
    howItWorks: [
      '<strong>Tell me your story.</strong> How you met, your partner, the families, the people you want to thank.',
      '<strong>I write your draft</strong>, a complete, beautifully balanced bride speech.',
      '<strong>We refine it together</strong> until it’s exactly right.',
    ],
    guidePath: null,
    guideLabel: null,
    faqs: [
      { q: 'Do brides really give speeches now?', a: 'Increasingly, yes, and they’re often the highlight. It’s a lovely way to thank people and speak about your partner in your own words.' },
      { q: 'How do you balance funny and heartfelt?', a: 'Laughs to settle the nerves, sincerity built towards the toast, judged for the room.' },
      { q: 'How do I thank everyone without it dragging?', a: 'I weave the thanks into the story so they feel warm, not like a list.' },
      { q: 'How long does it take?', a: `Usually ${T} days; last-minute help available.` },
      { q: 'Will it sound like me?', a: 'Always, it’s your voice and your story.' },
    ],
  },
  {
    ...
    cardImage: '/images/eulogy-candle.webp',
    ...
    withPrice: false,
    heroImage: '/images/eulogy-candle.webp',
